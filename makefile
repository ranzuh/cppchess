...
OBJECTS = main.o position.o movegen.o hashtable.o uci.o search.o evaluation.o perft.o linear_evaluation.o
SOURCES = main.cpp position.cpp movegen.cpp hashtable.cpp uci.cpp search.cpp evaluation.cpp perft.cpp linear_evaluation.cpp
